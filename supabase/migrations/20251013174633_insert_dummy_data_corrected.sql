/*
  ...
  1. Dummy Profiles
    - Creates 5 test user profiles with realistic data
    - Uses open-source stock images for profile pictures and banners
    
  2. Dummy Social Links
    - Adds social media links for each profile
    - Includes Instagram, LinkedIn, and Twitter handles
    
  3. Dummy Locations
    - Adds location data for nearby user testing
    - Coordinates centered around a test location
    
  4. Dummy Posts
    - Creates posts from each user
    - Uses open-source stock images
    
  Important Notes
    - All images use Pexels open-source stock photos
    - Coordinates are within ±0.01 proximity for testing
...
BEGIN
  INSERT INTO profiles (id, display_name, user_name, email, account_created_at)
  VALUES
  ...
  INSERT INTO social_links (id, instagram, linkedin, x_twitter, bio, profile_pic_url, banner_url)
  VALUES
  ...
  INSERT INTO locations (id, lat_full, long_full, lat_short, long_short, updated_at)
  VALUES
  ...
  VALUES
    ...
    (user2_id, 'Coffee and design – the perfect combination for a productive morning ☕️',
